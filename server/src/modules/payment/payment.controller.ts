...
import { IOrderItem, IShippingInfo } from "../order/order.model.js";
...
export const createPaymentIntent = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, { clientSecret: paymentIntent.client_secret }));
});

export const newCoupon = asyncHandler(
  async (req: Request<{}, {}, ICoupon>, res: Response) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(201, coupon, "Coupon successfully created"));
  },
);
...
export const allCoupons = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(201, coupons, "Coupon applied successfully "));
});
...
export const deleteCoupon = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(201, null, "Coupon deleted successfully"));
  },
);
...
export const updateCoupon = asyncHandler(
  async (req: Request<{}, {}, ICoupon>, res: Response) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, coupon, "Coupon successfully updated"));
  },
);
