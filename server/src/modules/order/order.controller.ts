...
export const getMyOrders = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, orders, "Orders successfully fetched"));
});
...
export const getSingleOrder = asyncHandler(
  async (req: Request, res: Response) => {
                  ...
                  "$$item",
                  {
                    image: {
                      $let: {
                        ...
                        in: {
                          $arrayElemAt: ["$$matchedProduct.images.image", 0],
                        },
                      },
                    },
                  },
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, order[0], "Order successfully fetched"));
  },
);
    ...
    if (
      ...
      switch (order.orderStatus) {
        ...
        case "Cancelled":
          return res
            .status(200)
            .json(new ApiResponse(200, null, "Order already cancelled"));
        default:
          return res
            .status(200)
            .json(new ApiResponse(200, null, "Order already delivered"));
      }
    }
